...
namespace TG.Sound
{
    ...
    public class OggPlayEventArgs : EventArgs
	{
        ...
        public OggPlayEventArgs(bool success, string reasonForFailure, int Id, string fileName,
            int volumeLevel, int balance, int errorHoleCount, int errorBadLinkCount, bool stopRequest)
        {
        ...
        public OggPlayEventArgs(int Id, int volumeLevel, int balance)
            : this(Id)
        {
            this.volumeLevel = volumeLevel;
            this.balance = balance;
        ...
        public OggPlayEventArgs(int Id, string fileName, int volumeLevel, int balance)
            : this(Id, fileName)
        {
            this.volumeLevel = volumeLevel;
            this.balance = balance;
