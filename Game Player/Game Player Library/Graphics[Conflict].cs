...
namespace Game_Player
{
    ...
    public static class Graphics
    {
        ...
        public static Texture2D Draw(bool textureOut)
        {
            ...
            if (textureOut)
            {
                target = (RenderTarget2D)GraphicsDevice.GetRenderTargets()[0].RenderTarget;
                oldTarget = target;
            ...
            if (Math.Abs(fading) > 0)
            {
                ...
                color = new Microsoft.Xna.Framework.Graphics.Color((byte)255, (byte)255, (byte)255, (byte)(255.0 * faded));
                SpriteBatch.Draw(
                    lastFrame,
                ...
                if (!blankTransition)
                {
                    TransEffect.Techniques["Transition"].Passes[0].End();
                    TransEffect.End();
                }
