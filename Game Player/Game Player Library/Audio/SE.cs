...
namespace Game_Player
{
    public static class SE
    {
        ...
        //public static string RootPath = @"C:\Program Files\Common Files\Enterbrain\RGSS\Standard\Audio\SE\";
        ...
        public static void Play(String filepath, double volume, Boolean repeat)
        {
            if (audio != null)
            { audio.Dispose(); }
            string path = Paths.FindValidPath(@"Audio\SE\" + filepath, paths, exts);
            if (path == "")
                return;
