...
namespace Game_Player
{
    public static class BGM
    {
        ...
        //public static string RootPath = @"C:\Program Files\Common Files\Enterbrain\RGSS\Standard\Audio\BGM\";
        //public static string FileExtension = ".mid";

        static private string playing;
        static public string Playing
        {
            get { return playing; }
            set { playing = value; }
        }
        ...
        public static void Play(String filepath, double volume, double tempo, Boolean repeat)
        {
            if (audio != null)
            { audio.Dispose(); }
            string path = Paths.FindValidPath(@"Audio\BGM\" + filepath, paths, exts);
            if (path == "")
                return;
